...
public class MuAlloyGuiUtil {
    ...
    public static JPanel makeSummary(int numP, int numF, long totalTime, Font font) {
        ...
        JLabel passingLabel = new JLabel("<html>Passing: <b><font color = green>" + numP, OurUtil.loadIcon("two.png"), JLabel.CENTER);
        passingLabel.setHorizontalTextPosition(JLabel.CENTER);
        passingLabel.setFont(font);
        summary.add(passingLabel);
        JLabel failingLabel = new JLabel("<html>Failing: <b><font color = red>" + numF, OurUtil.loadIcon("five.png"), JLabel.CENTER);
